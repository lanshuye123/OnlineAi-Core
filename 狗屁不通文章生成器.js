...
let 论述 = [ 
    "现在，解决set.主题的问题，是非常非常重要的。 所以， ",
    "我们不得不面对一个非常尴尬的事实，那就是， ",
    "set.主题的发生，到底需要如何做到，不set.主题的发生，又会如何产生。 ",
    "而这些并不是完全重要，更加重要的问题是， ",
    "set.主题，到底应该如何实现。 ",
    "带着这些问题，我们来审视一下set.主题。 ",
    "所谓set.主题，关键是set.主题需要如何写。 ",
    "我们一般认为，抓住了问题的关键，其他一切则会迎刃而解。 ",
    "问题的关键究竟为何? ",
    "set.主题因何而发生?",
    "每个人都不得不面对这些问题。  在面对这种问题时， ",
    "一般来讲，我们都必须务必慎重的考虑考虑。 ",
    "要想清楚，set.主题，到底是一种怎么样的存在。 ",
    "了解清楚set.主题到底是一种怎么样的存在，是解决一切问题的关键。 ",
    "就我个人来说，set.主题对我的意义，不能不说非常重大。 ",
    "本人也是经过了深思熟虑，在每个日日夜夜思考这个问题。 ",
    "set.主题，发生了会如何，不发生又会如何。 ",
    "在这种困难的抉择下，本人思来想去，寝食难安。 ",
    "生活中，若set.主题出现了，我们就不得不考虑它出现了的事实。 ",
...
let 名人名言 = [
    ...
    "蓝树叶曾经当着所有Ai用户说,<在线智能>是一定会持续更新的更新。这不禁令我深思"
]
...
function 来点论述(){
    let 句子 = 随便取一句(论述);
    句子 = 句子.replace(RegExp("set.主题", "g"),set.主题);
    return 句子;
}
